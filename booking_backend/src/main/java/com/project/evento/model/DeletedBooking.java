...
public class DeletedBooking {
	...
	public String toString() {
		return "DeletedBooking [record_id=" + record_id + ", booking_id=" + booking_id + ", customer_id=" + customer_id
				+ ", booking_date=" + booking_date + ", event_type=" + event_type + ", location_id=" + location_id
				+ ", gusts=" + gusts + ", total=" + total + ", date=" + date + ", status=" + status + "]";
	}
}
