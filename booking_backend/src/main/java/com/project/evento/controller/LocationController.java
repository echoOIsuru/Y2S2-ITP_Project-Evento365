...
import com.project.evento.repository.DeleteLocationRepository;
...
public class LocationController {
	...
	@Autowired
	private DeleteLocationRepository deleteLocationRepository;
	...
	//get all 
		...
		//get deleted booking by id rest API
		@GetMapping("/deletelocations/{value}")
		public ResponseEntity<DeletedLocation> getDeletedBookingByID(@PathVariable Long value) {
			DeletedLocation location = deleteLocationRepository.getDeleteLocation(value);
