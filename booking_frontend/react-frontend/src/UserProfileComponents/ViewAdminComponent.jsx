        ...
        return (
            ...
            <div>
                ...
                <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3  border-bottom box-shadow" style={{width:'100%',margin:'auto',borderRadius:'5px',boxShadow:'0px 0px 45px -5px',background:'rgb(250, 235, 215,0.8)' }}>
                    ...
                    <button class="btn btn-secondary" onClick={this.backToUserPage.bind(this)} href="#"style={{marginRight:'30px'}}>❮</button>
                    <button class="btn btn-secondary" onClick={this.backToUserPage.bind(this)} style={{marginRight:'30px'}}>USERS</button>
                    <button class="btn btn-secondary" style={{marginRight:'30px'}}>HOME</button> 
                    <button class="btn btn-secondary" onClick={this.logout.bind(this)}style={{marginRight:'30px'}}>LOGOUT</button> 
                    <button class="btn btn-secondary" href="#"style={{marginRight:'5px'}}>❯</button>
                </div>
                <br />
