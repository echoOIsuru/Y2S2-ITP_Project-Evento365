...
class CreateCustomerComponentAdmin extends React.Component {
    ...
    saveOrUpdateCustomer = (e) => {
        ...
        if (this.state.id === '_addcus') {
            CustomerService.createCustomer(customer).then(res => {
                this.props.history.push('/list-customer/' + this.state.id);
            });
        } else {
    ...
    changeGender() {
        if (this.state.gender === 'Male') {
            return (
                <div>
                    <select class="custom-select d-block w-100 text-left" onChange={this.changeGenderHandler} name="secQues" disabled>
        ...
        return (
            <div >
                ...
                <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3  border-bottom box-shadow" style={{ width: '100%', margin: 'auto', borderRadius: '5px', boxShadow: '0px 0px 45px -5px', background: 'rgb(250, 235, 215,0.8)' }}>
                    <h5 class="my-0 mr-md-auto font-weight-normal">MAIN ADMIN ➔ CUSTOMER PROFILE</h5>
                    <button class="btn btn-outline-primary" onClick={this.goBack.bind(this)} style={{ marginRight: '30px' }}>❮</button>
                ...
                <div class="container">
                    <Grid container spacing={2} justify="center">
                        <div className="text-center transformDiv" style={{ width: '750px', height: '1050px' }}>
                            ...
                            <form class="needs-validation" onSubmit={this.saveOrUpdateCustomer} novalidate>
                                ...
                                <div class="mb-3 text-left">
                                    <label >Name</label>
                                    <input type="text" value={this.state.name} onChange={this.changeNameHandler} class="form-control" placeholder="Ex : John Doe" disabled/>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3 text-left">
                                        <label for="firstName">Email</label>
                                        <input type="text" value={this.state.email} onChange={this.changeEmailHandler} class="form-control" placeholder="abc@example.com" title='format : example@123.com' pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" disabled />
                                    ...
                                    <div class="col-md-6 mb-3 text-left">
                                        ...
                                        <input type="text" value={this.state.nic} onChange={this.changeNICHandler} class="form-control" placeholder="123456789V" pattern="[0-9]{9}[V]" title="Ex : 123456789V (Nine digits + V)" disabled />
                                        <div class="invalid-feedback">
                                ...
                                <div class="mb-3 text-left">
                                    <label >Address</label>
                                    <input type="text" value={this.state.address} onChange={this.changeAddressHandler} class="form-control" id="email" placeholder="Address" disabled />

                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3 text-left">
                                        <label for="firstName">Username</label>
                                        <input type="text" value={this.state.username} onChange={this.changeUsernameHandler} class="form-control" pattern="[A-Za-z0-9]{5,20}" title="Minimum :5 Maximum:20 (Letters/Numbers)" disabled />
                                        <div class="invalid-feedback">
                                            Valid first name is required.
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3 text-left">
                                        ...
                                        <input type="password" value={this.state.password} onChange={this.changePasswordHandler} class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                            title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" disabled/>
                                        <div class="invalid-feedback">
                                            Valid last name is required.
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 text-left">
                                        ...
                                        <input type="date" value={this.state.birthday} onChange={this.changeBirthdayHandler} class="form-control" disabled />
                                        <div class="invalid-feedback">
                                            Valid first name is required.
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3 text-left">
                                        ...
                                        <input type="text" value={this.state.mobile} onChange={this.changeMobileHandler} class="form-control" placeholder="077-XXXXXXX" pattern="[0-9]{10}" title="Must be 10 digits long." disabled />
                                        <div class="invalid-feedback">
                                            Valid last name is required.
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3 text-left">
                                    ...
                                    <div class="input-group">
                                        <input type="text" value={this.state.image} onChange={this.changeImageHandler} class="form-control" placeholder="Ex: https://picsum.photos/200/300" disabled/>
                                    </div>
                                </div>
                                <hr class="mb-4 " />
...
export default CreateCustomerComponentAdmin;